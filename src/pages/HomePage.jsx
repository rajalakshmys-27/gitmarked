            ...
            <div className="max-w-6xl mx-auto">
                <div className="pt-8 md:pt-12 flex flex-col items-center gap-8">
                    <div className="text-center ">
                        <h1 className="text-4xl font-bold mb-3 text-gray-900 dark:text-white">Welcome to GitMarked</h1>
                        ...
                        <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                            ...
                            <h2 className="text-2xl font-semibold mb-3 text-gray-900 dark:text-white">Insightful Dashboard</h2>
